...
- [ ] Remove the tracked public `docs/` directory and add ignore protection so future documentation and competitor-comparison files are not committed to the public repository.
