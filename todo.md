...
- [x] Replace the Vercel-incompatible relative logo route with the verified direct CDN asset URL, then redeploy and confirm the stable production asset response is `image/png`. The CDN response was checked directly before release.
