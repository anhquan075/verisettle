...
export const deals = mysqlTable(
  "deals",
  {
    ...
    policyVersion: mysqlEnum("policyVersion", ["v1_live", "v2_draft"]).notNull().default("v1_live"),
    ...
    policySourceContract: varchar("policySourceContract", { length: 42 }),
    acceptanceExpiresAt: timestamp("acceptanceExpiresAt"),
    minimumSourceConfirmations: int("minimumSourceConfirmations"),
    refundWindowSeconds: int("refundWindowSeconds"),
