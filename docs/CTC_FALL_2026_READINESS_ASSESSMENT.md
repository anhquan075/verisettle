...
| Prototype demo video URL | Public wide real-interface walkthrough: <https://files.manuscdn.com/user_upload_by_module/session_file/119889830/dlOeQIgcaQXpfdIv.mp4>. Subtitle track: <https://files.manuscdn.com/user_upload_by_module/session_file/119889830/FNhOQLsGMsKPovCo.srt>. | **Ready** | 1280 × 720 MP4 with deliberate component-level scrolling, restrained callouts, opaque-white subtitles, and a synchronized subtitle track was visually verified before inclusion in the draft. |
