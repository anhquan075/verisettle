...
| Prototype demo video URL | Public real-interface walkthrough: <https://files.manuscdn.com/user_upload_by_module/session_file/119889830/NDrMzQOoGlsOrWkt.mp4>. Subtitle track: <https://files.manuscdn.com/user_upload_by_module/session_file/119889830/FNhOQLsGMsKPovCo.srt>. | **Ready** | Public MP4 and synchronized subtitle track verified before inclusion in the draft. |
