...
export default function JudgeEvidence() {
  ...
  return (
    <div className="veri-shell min-h-screen overflow-x-clip text-white">
      <a href="#judge-evidence" className="sr-only z-50 rounded-md bg-cyan-200 px-3 py-2 text-sm font-semibold text-slate-950 focus:not-sr-only focus:fixed focus:left-4 focus:top-4">Skip to evidence</a>
