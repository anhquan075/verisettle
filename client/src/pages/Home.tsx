      ...
      <main id="landing-content" className="relative mx-auto max-w-7xl px-5 pb-24 pt-10 sm:px-8 sm:pt-16 lg:pt-20">
        <section className="grid gap-12 lg:grid-cols-[1.04fr_0.96fr] lg:items-center lg:gap-16">
          <div>
            ...
            <motion.p initial={entrance} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.45, delay: shouldReduceMotion ? 0 : 0.16, ease: [0.23, 1, 0.32, 1] }} className="mt-6 max-w-xl text-base leading-7 text-slate-300 sm:text-lg">Sepolia approval. Attestcoin proof. Creditcoin release.</motion.p>
