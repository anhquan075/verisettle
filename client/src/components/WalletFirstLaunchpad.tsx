...
import { FundingReceiptEmbed } from "@/components/FundingReceiptEmbed";
    ...
    <section id="wallet-launchpad" aria-label="Wallet sign-in" className="relative overflow-hidden rounded-[1.75rem] border border-cyan-100/15 bg-[#061116] p-5 shadow-[0_20px_70px_rgba(0,0,0,0.25)] sm:p-8">
      ...
      <div className="relative mx-auto max-w-4xl">
        <header className="max-w-2xl">
          ...
          <p className="mt-3 max-w-xl text-sm leading-6 text-slate-300">Connect, sign once, then check both testnets. No keys or transaction approvals.</p>
        </header>
          ...
          <div className="rounded-2xl border border-white/10 bg-black/20 p-4 sm:p-5">
            {!wallet.address ? (
              ...
              <div>
                ...
                <p className="mt-1 text-sm leading-6 text-slate-400">Sign one VeriSettle message for a 24-hour session. No transaction.</p>
              ...
              <div>
                ...
                <p className="mt-1 text-sm leading-6 text-slate-400">Use CC3 for escrow and Sepolia for acceptance. You approve each switch.</p>
